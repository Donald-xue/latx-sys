...
static inline int lsenv_offset_of_guest_base(ENV *lsenv)
{
...
static inline ADDR lsenv_get_guest_base(ENV *lsenv)
{
    return (ADDR)lsenv_get_vreg(lsenv, 0);
}

static inline void lsenv_set_guest_base(ENV *lsenv, ADDR gbase)
{
