...
static void latxs_translate_add_sub_byhand_gpr_gpr(IR1_INST *pir1,
        IR1_OPND   *opnd0,
        IR1_OPND   *opnd1,
        IR2_OPCODE  lisa_op,
        IR2_OPCODE  lbt_op)
{
    ...
    int os = ir1_opnd_size(opnd0); /* 8, 16, 32 */
    LATXS_FLAG_REDUCTION_CHECKIF(pir1)
...
static void latxs_translate_adc_sbc_byhand_gpr_gpr(IR1_INST *pir1,
        IR1_OPND   *opnd0,
        IR1_OPND   *opnd1,
        IR2_OPCODE  lisa_op,
        IR2_OPCODE  lbt_op)
...
static void latxs_translate_add_sub_byhand_gpr_imm(IR1_INST *pir1,
        IR1_OPND   *opnd0,
        IR1_OPND   *opnd1,
        IR2_OPCODE  lisa_op,
        IR2_OPCODE  lbt_op)
...
static void latxs_translate_adc_sbc_byhand_gpr_imm(IR1_INST *pir1,
        IR1_OPND   *opnd0,
        IR1_OPND   *opnd1,
        IR2_OPCODE  lisa_op,
        IR2_OPCODE  lbt_op)
...
static void latxs_translate_add_sub_byhand_gpr_mem(IR1_INST *pir1,
        IR1_OPND   *opnd0,
        IR1_OPND   *opnd1,
        IR2_OPCODE  lisa_op,
        IR2_OPCODE  lbt_op)
...
static void latxs_translate_adc_sbc_byhand_gpr_mem(IR1_INST *pir1,
        IR1_OPND   *opnd0,
        IR1_OPND   *opnd1,
        IR2_OPCODE  lisa_op,
        IR2_OPCODE  lbt_op)
...
static void latxs_translate_add_sub_byhand_mem_gpr(IR1_INST *pir1,
        IR1_OPND   *opnd0,
        IR1_OPND   *opnd1,
        IR2_OPCODE  lisa_op,
        IR2_OPCODE  lbt_op)
...
static void latxs_translate_adc_sbc_byhand_mem_gpr(IR1_INST *pir1,
        IR1_OPND   *opnd0,
        IR1_OPND   *opnd1,
        IR2_OPCODE  lisa_op,
        IR2_OPCODE  lbt_op)
...
static void latxs_translate_add_sub_byhand_mem_imm(IR1_INST *pir1,
        IR1_OPND   *opnd0,
        IR1_OPND   *opnd1,
        IR2_OPCODE  lisa_op,
        IR2_OPCODE  lbt_op)
...
static void latxs_translate_adc_sbc_byhand_mem_imm(IR1_INST *pir1,
        IR1_OPND   *opnd0,
        IR1_OPND   *opnd1,
        IR2_OPCODE  lisa_op,
        IR2_OPCODE  lbt_op)
        ...
        IR2_OPCODE  lbt_op)
{
    ...
    if (ir1_opnd_is_gpr(opnd0)) {
        if (ir1_opnd_is_gpr(opnd1)) {
            latxs_translate_add_sub_byhand_gpr_gpr(pir1, opnd0, opnd1,
                    lisa_op, lbt_op);
        } else if (ir1_opnd_is_imm(opnd1)) {
            latxs_translate_add_sub_byhand_gpr_imm(pir1, opnd0, opnd1,
                    lisa_op, lbt_op);
        } else {
            latxs_translate_add_sub_byhand_gpr_mem(pir1, opnd0, opnd1,
                    lisa_op, lbt_op);
        }
    } else {
        if (ir1_opnd_is_gpr(opnd1)) {
            latxs_translate_add_sub_byhand_mem_gpr(pir1, opnd0, opnd1,
                    lisa_op, lbt_op);
        } else {
            latxs_translate_add_sub_byhand_mem_imm(pir1, opnd0, opnd1,
                    lisa_op, lbt_op);
        }
    }
        ...
        IR2_OPCODE  lbt_op)
{
    ...
    if (ir1_opnd_is_gpr(opnd0)) {
        if (ir1_opnd_is_gpr(opnd1)) {
            latxs_translate_adc_sbc_byhand_gpr_gpr(pir1, opnd0, opnd1,
                    lisa_op, lbt_op);
        } else if (ir1_opnd_is_imm(opnd1)) {
            latxs_translate_adc_sbc_byhand_gpr_imm(pir1, opnd0, opnd1,
                    lisa_op, lbt_op);
        } else {
            latxs_translate_adc_sbc_byhand_gpr_mem(pir1, opnd0, opnd1,
                    lisa_op, lbt_op);
        }
    } else {
        if (ir1_opnd_is_gpr(opnd1)) {
            latxs_translate_adc_sbc_byhand_mem_gpr(pir1, opnd0, opnd1,
                    lisa_op, lbt_op);
        } else {
            latxs_translate_adc_sbc_byhand_mem_imm(pir1, opnd0, opnd1,
                    lisa_op, lbt_op);
        }
    }
...
static void latxs_translate_inc_dec_byhand_gpr(IR1_INST *pir1,
        IR1_OPND   *opnd0,
        IR2_OPCODE  lbt_op,
        int         addend)
{
...
static void latxs_translate_inc_dec_byhand_mem(IR1_INST *pir1,
        IR1_OPND   *opnd0,
        IR2_OPCODE  lbt_op,
        int         addend)
{
        ...
        int         addend)
{
    ...
    if (ir1_opnd_is_gpr(opnd0)) {
        latxs_translate_inc_dec_byhand_gpr(pir1, opnd0, lbt_op, addend);
    } else {
        latxs_translate_inc_dec_byhand_mem(pir1, opnd0, lbt_op, addend);
    }
...
static void latxs_translate_neg_byhand_gpr(IR1_INST *pir1,
        IR1_OPND *opnd0)
{
    IR2_OPND gpr = latxs_convert_gpr_opnd(opnd0, EXMode_S);
...
static void latxs_translate_neg_byhand_mem(IR1_INST *pir1,
        IR1_OPND *opnd0)
{
    IR2_OPND tmp = latxs_ra_alloc_itemp();
    latxs_load_ir1_mem_to_ir2(&tmp, opnd0, EXMode_S, -1);
...
bool latxs_translate_neg_byhand(IR1_INST *pir1)
{
    ...
    if (ir1_opnd_is_gpr(opnd0)) {
        latxs_translate_neg_byhand_gpr(pir1, opnd0);
    } else {
        latxs_translate_neg_byhand_mem(pir1, opnd0);
    }
...
static void __latxs_translate_mul_byhand_eax(IR1_INST *pir1,
...
static void latxs_translate_mul_byhand_gpr(IR1_INST *pir1, IR1_OPND *opnd0)
{
    int os = ir1_opnd_size(opnd0);
    IR2_OPND gpr = latxs_convert_gpr_opnd(opnd0, EXMode_Z);
    __latxs_translate_mul_byhand_eax(pir1, &gpr, os, EXMode_Z, LISA_X86MUL_BU);
}

static void latxs_translate_mul_byhand_mem(IR1_INST *pir1, IR1_OPND *opnd0)
{
    int os = ir1_opnd_size(opnd0);
    IR2_OPND mem = latxs_ra_alloc_itemp();
    latxs_load_ir1_mem_to_ir2(&mem, opnd0, EXMode_Z, -1);
    __latxs_translate_mul_byhand_eax(pir1, &mem, os, EXMode_Z, LISA_X86MUL_BU);
}
...
bool latxs_translate_mul_byhand(IR1_INST *pir1)
{
    ...
    if (ir1_opnd_is_gpr(opnd0)) {
        latxs_translate_mul_byhand_gpr(pir1, opnd0);
    } else {
        latxs_translate_mul_byhand_mem(pir1, opnd0);
    }
...
static void latxs_translate_imul_byhand_1(IR1_INST *pir1)
{
    ...
    if (ir1_opnd_is_gpr(opnd0)) {
        IR2_OPND gpr = latxs_convert_gpr_opnd(opnd0, EXMode_S);
        __latxs_translate_mul_byhand_eax(pir1, &gpr, os, EXMode_S, LISA_X86MUL_B);
    } else {
        IR2_OPND mem = latxs_ra_alloc_itemp();
        latxs_load_ir1_mem_to_ir2(&mem, opnd0, EXMode_S, -1);
        __latxs_translate_mul_byhand_eax(pir1, &mem, os, EXMode_S, LISA_X86MUL_B);
