...
#define TARGET_DRM_IOCTL_GET_CLIENT             TARGET_IOWR('d', 0x05, struct drm_client)
...
#define TARGET_DRM_IOCTL_SET_CLIENT_CAP         TARGET_IOWR('d', 0x0d, struct drm_set_client_cap)
