  ...
  IOCTL(DRM_IOCTL_SET_CLIENT_CAP, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_set_client_cap)))
  ...
  IOCTL(DRM_IOCTL_SET_SAREA_CTX, IOC_W,MK_PTR(MK_STRUCT(STRUCT_drm_ctx_priv_map)))
  IOCTL(DRM_IOCTL_GET_SAREA_CTX, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_ctx_priv_map)))
  ...
  IOCTL(DRM_IOCTL_SG_ALLOC, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_scatter_gather)))
  IOCTL(DRM_IOCTL_SG_FREE, IOC_W, MK_PTR(MK_STRUCT(STRUCT_drm_scatter_gather)))
  IOCTL(DRM_IOCTL_WAIT_VBLANK, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_wait_vblank_reply)))
  IOCTL(DRM_IOCTL_UPDATE_DRAW, IOC_W,MK_PTR(MK_STRUCT(STRUCT_drm_update_draw)))
  IOCTL(DRM_IOCTL_MODE_GETRESOURCES, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_card_res)))
  IOCTL(DRM_IOCTL_MODE_GETCRTC, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_crtc)))
  IOCTL(DRM_IOCTL_MODE_SETCRTC, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_crtc)))
  IOCTL(DRM_IOCTL_MODE_CURSOR, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_cursor)))
  IOCTL(DRM_IOCTL_MODE_GETGAMMA, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_crtc_lut)))
  IOCTL(DRM_IOCTL_MODE_SETGAMMA, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_crtc_lut)))
  IOCTL(DRM_IOCTL_MODE_GETENCODER, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_get_encoder)))
  IOCTL(DRM_IOCTL_MODE_GETCONNECTOR, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_get_connector)))
  IOCTL(DRM_IOCTL_MODE_ATTACHMODE, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_mode_cmd)))
  IOCTL(DRM_IOCTL_MODE_DETACHMODE, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_mode_cmd)))
  IOCTL(DRM_IOCTL_MODE_GETPROPERTY, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_get_property)))
  IOCTL(DRM_IOCTL_MODE_SETPROPERTY, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_connector_set_property)))
  IOCTL(DRM_IOCTL_MODE_GETPROPBLOB, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_get_blob)))
  IOCTL(DRM_IOCTL_MODE_GETFB, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_fb_cmd)))
  IOCTL(DRM_IOCTL_MODE_ADDFB, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_fb_cmd)))
  IOCTL(DRM_IOCTL_MODE_RMFB, IOC_RW, TYPE_INT)
  IOCTL(DRM_IOCTL_MODE_PAGE_FLIP, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_crtc_page_flip)))
  IOCTL(DRM_IOCTL_MODE_DIRTYFB, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_fb_dirty_cmd)))
  IOCTL(DRM_IOCTL_MODE_CREATE_DUMB, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_create_dumb)))
  IOCTL(DRM_IOCTL_MODE_MAP_DUMB, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_map_dumb)))
  IOCTL(DRM_IOCTL_MODE_DESTROY_DUMB, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_destroy_dumb)))
  IOCTL(DRM_IOCTL_MODE_GETPLANERESOURCES, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_get_plane_res)))
  IOCTL(DRM_IOCTL_MODE_GETPLANE, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_get_plane)))
  IOCTL(DRM_IOCTL_MODE_SETPLANE, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_set_plane)))
  IOCTL(DRM_IOCTL_MODE_ADDFB2, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_fb_cmd2)))
  IOCTL(DRM_IOCTL_MODE_OBJ_GETPROPERTIES, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_obj_get_properties)))
  IOCTL(DRM_IOCTL_MODE_OBJ_SETPROPERTY, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_obj_set_property)))
  IOCTL(DRM_IOCTL_MODE_CURSOR2, IOC_RW,MK_PTR(MK_STRUCT(STRUCT_drm_mode_cursor2)))

  IOCTL(DRM_IOCTL_RADEON_CP_INIT    , IOC_W , MK_PTR(MK_STRUCT(STRUCT_drm_radeon_init)))
  IOCTL(DRM_IOCTL_RADEON_CP_START   , 0, TYPE_NULL)
  IOCTL(DRM_IOCTL_RADEON_CP_STOP    , IOC_W , MK_PTR(MK_STRUCT(STRUCT_drm_radeon_cp_stop)))
  ...
  IOCTL(DRM_IOCTL_RADEON_FULLSCREEN , IOC_W , MK_PTR(MK_STRUCT(STRUCT_drm_radeon_fullscreen)))
  IOCTL(DRM_IOCTL_RADEON_SWAP       , 0, TYPE_NULL)
  IOCTL(DRM_IOCTL_RADEON_CLEAR      , IOC_W , MK_PTR(MK_STRUCT(STRUCT_drm_radeon_clear)))
  IOCTL(DRM_IOCTL_RADEON_VERTEX     , IOC_W , MK_PTR(MK_STRUCT(STRUCT_drm_radeon_vertex)))
  IOCTL(DRM_IOCTL_RADEON_INDICES    , IOC_W , MK_PTR(MK_STRUCT(STRUCT_drm_radeon_indices)))
  IOCTL(DRM_IOCTL_RADEON_STIPPLE    , IOC_W , MK_PTR(MK_STRUCT(STRUCT_drm_radeon_stipple)))
  IOCTL(DRM_IOCTL_RADEON_INDIRECT   , IOC_RW, MK_PTR(MK_STRUCT(STRUCT_drm_radeon_indirect)))
  // IOCTL(DRM_IOCTL_RADEON_TEXTURE    , IOC_RW, MK_PTR(MK_STRUCT(STRUCT_drm_radeon_texture)))
  // IOCTL(DRM_IOCTL_RADEON_VERTEX2    , IOC_W , MK_PTR(MK_STRUCT(STRUCT_drm_radeon_vertex2)))
  // IOCTL(DRM_IOCTL_RADEON_CMDBUF     , IOC_W , MK_PTR(MK_STRUCT(STRUCT_drm_radeon_cmd_buffer)))
  IOCTL(DRM_IOCTL_RADEON_GETPARAM   , IOC_RW, MK_PTR(MK_STRUCT(STRUCT_drm_radeon_getparam)))
  IOCTL(DRM_IOCTL_RADEON_FLIP       , 0, TYPE_NULL)
  IOCTL(DRM_IOCTL_RADEON_ALLOC      , IOC_RW, MK_PTR(MK_STRUCT(STRUCT_drm_radeon_mem_alloc)))
  IOCTL(DRM_IOCTL_RADEON_FREE       , IOC_W , MK_PTR(MK_STRUCT(STRUCT_drm_radeon_mem_free)))
  IOCTL(DRM_IOCTL_RADEON_INIT_HEAP  , IOC_W , MK_PTR(MK_STRUCT(STRUCT_drm_radeon_mem_init_heap)))
  IOCTL(DRM_IOCTL_RADEON_IRQ_EMIT   , IOC_RW, MK_PTR(MK_STRUCT(STRUCT_drm_radeon_irq_emit)))
  IOCTL(DRM_IOCTL_RADEON_IRQ_WAIT   , IOC_W , MK_PTR(MK_STRUCT(STRUCT_drm_radeon_irq_wait)))
  IOCTL(DRM_IOCTL_RADEON_CP_RESUME  , 0, TYPE_NULL )
  IOCTL(DRM_IOCTL_RADEON_SETPARAM   , IOC_W , MK_PTR(MK_STRUCT(STRUCT_drm_radeon_setparam)))
  IOCTL(DRM_IOCTL_RADEON_SURF_ALLOC , IOC_W , MK_PTR(MK_STRUCT(STRUCT_drm_radeon_surface_alloc)))
  ...
  IOCTL_SPECIAL(DRM_IOCTL_RADEON_GEM_CREATE ,IOC_RW, do_ioctl_drm ,MK_PTR(MK_STRUCT(STRUCT_drm_radeon_gem_create)))
